from modelo_fsc  import modelo_for_shape_complation as load_MFSC
...
#model = load_model(relative_name_folder + '/model-095-0.015295.h5')
#try:
#	model.save_weights('DataM.h5')
#except:
#	print('file exists do not was created')

#del(model)
MFSC = load_MFSC()
#MFSC.load_weights('Data.h5')
...
history = MFSC.fit([view_1, view_2, view_3, view_4, view_5, view_6],X_train,
	epochs = epochs,
	batch_size = batch_size,
	validation_data = ([view_1_val, view_2_val, view_3_val, view_4_val, view_5_val, view_6_val],X_val),
	callbacks = [TensorBoard(log_dir = '/tmp/dos'),checkpoint])
#tensorboard --logdir=/tmp/dos
#http://0.0.0.0:6006
